...
var interpolation = (function () {
		...
		drawBasicImage = function () {
			...
			//draw the points
			if(pointsX.length == 1)
	   			context.fillText("There is "+pointsX.length+" interpolation point", canvasWidth-250, border);
			else    
	   			context.fillText("There are "+pointsX.length+" interpolation points", canvasWidth-250, border);
			for (var i = 0; i<pointsX.length; i+=1) {
				var qx = pointsX[i];
				var qy = pointsY[i];
				context.beginPath();
